...
export const adhkarData: AdhkarItem[] = [
  {
    ...
    title: "Upon Waking",
    arabic:
      "الحَمْدُ لِلَّهِ الَّذِي أَحْيَانَا بَعْدَ مَا أَمَاتَنَا وَإِلَيْهِ النُّشُورُ",
    transliteration:
...

  {
    ...
    transliteration:
      "La ilaha illallahu wahdahu la sharika lah, lahul-mulku wa lahul-hamdu, wa huwa 'ala kulli shay'in qadir. Subhanallah, walhamdu lillah, wa la ilaha illallah, wallahu akbar. Wa la hawla wa la quwwata illa billahil-'aliyyil-'azim. Rabbighfir li.",
    meaning:
...

  {
    ...
    meaning:
      "Praise is to Allah who gave strength to my body, returned my soul to me, and allowed me to remember Him.",
  },
...
`,
...

  {
    ...
    arabic: `
اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ۚ لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ ۚ لَّهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ ۗ
...
Wasi'a kursiyyuhu as-samawati wal-ard.
Wa la ya'uduhu hifzuhuma.
Wa huwa al-'aliyyul-'azim.
`,
    meaning: `
There is no deity worthy of worship except Allah, the Ever-Living, the Sustainer of all existence.
...
`,
...

  {
    id: "m8",
    category: "morning",
    title: "Surah Al-Ikhlas, Al-Falaq, and An-Nas (3 times each)",
    arabic: `
...
Rabbi as'aluka khayra ma fi hadhal-yawm wa khayra ma ba'dah,
wa a'udhu bika min sharri ma fi hadhal-yawm wa sharri ma ba'dah.
Rabbi a'udhu bika minal-kasal wa su'il-kibar,
Rabbi a'udhu bika min 'adhabin fin-nar wa 'adhabin fil-qabr.
`,
    meaning: `
We have entered the morning and with it all dominion belongs to Allah. Praise is to Allah. None has the right to be worshipped except Allah alone without partner. His is the dominion and His is the praise, and He has power over all things. My Lord, I ask You for the good of this day and the good that follows it, and I seek refuge in You from the evil of this day and the evil that follows it. My Lord, I seek refuge in You from laziness and miserable old age. My Lord, I seek refuge in You from the punishment of the Fire and the punishment of the grave.
`,
  },
...
`,
  ...
  },
  {
    ...
    transliteration:
      "Lā ilāha illallāhu waḥdahu lā sharīka lah, lahul-mulku wa lahul-ḥamdu yuḥyī wa yumīt, wa huwa ‘alā kulli shay’in qadīr.",
    meaning:
      "There is no deity except Allah alone, without partner. His is the dominion and His is the praise. He gives life and causes death, and He is over all things capable.",
  },
  {
    id: "e6",
    category: "evening",
...

  {
    ...
    transliteration:
      "Allāhumma ‘ālim al-ghaybi wash-shahādah, fāṭir as-samāwāti wal-arḍ, rabba kulli shay’in wa malīkahu, ash-hadu an lā ilāha illā anta, a‘ūdhu bika min sharri nafsī, wa min sharri ash-shayṭāni wa shirkih, wa an aqtarifa ‘alā nafsī sū’an aw ajurrahu ilā muslim.",
    meaning:
  ...
  },
  {
    ...
    transliteration:
      "Bismillāhilladhī lā yaḍurru ma‘asmihi shay’un fil-arḍi wa lā fis-samā’i wa huwa as-Samī‘ul-‘Alīm.",
    meaning:
...

  {
    ...
    transliteration:
      "Allāhumma anta rabbī lā ilāha illā anta, khalaqtanī wa anā ‘abduk, wa anā ‘alā ‘ahdika wa wa‘dika mastata‘tu. A‘ūdhu bika min sharri mā ṣana‘tu. Abū’u laka bini‘matika ‘alayya wa abū’u bidhambī, faghfir lī fa innahu lā yaghfirudh-dhunūba illā anta.",
    meaning:
...

  {
    ...
    transliteration:
      "Allāhumma ‘āfinī fī badanī, Allāhumma ‘āfinī fī sam‘ī, Allāhumma ‘āfinī fī baṣarī, lā ilāha illā anta. Allāhumma innī a‘ūdhu bika minal-kufri wal-faqr, wa a‘ūdhu bika min ‘adhābil-qabr, lā ilāha illā anta.",
    meaning:
      "O Allah, grant me wellbeing in my body. O Allah, grant me wellbeing in my hearing. O Allah, grant me wellbeing in my sight. There is no deity except You. O Allah, I seek refuge in You from disbelief and poverty, and I seek refuge in You from the punishment of the grave. There is no deity except You.",
  },

  {
    ...
    transliteration:
      "Raḍītu billāhi Rabban, wa bil-Islāmi dīnan, wa bi-Muḥammadin ṣallallāhu ‘alayhi wa sallama nabiyyan.",
    meaning:
...
Al-ḥamdu lillāh (33x)
Allāhu akbar (33x)`,
    meaning: "Glory be to Allah, praise be to Allah, Allah is Great",
  },
  {
    id: "a2",
    category: "after-salah",
...
Qul a‘ūdhu birabbin-nās...`,
    meaning: "Recite Surah Ikhlas, Surah Falaq, and Surah Nas.",
  },
];
...
export const duaaData: DuaaItem[] = [
  ...
  },
  {
    ...
    transliteration:
      "Al-ḥamdu lillāhi alladhī aṭ‘amanā wa saqānā wa ja‘alanā minal-muslimīn",
    meaning:
  ...
  },
  {
    ...
    arabic:
      "اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ بِذَنْبِي فَاغْفِرْ لِي، فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ",
    transliteration:
      "Allāhumma anta rabbī lā ilāha illā anta, khalaqtanī wa anā ‘abduk, wa anā ‘alā ‘ahdika wa wa‘dika mastata‘t, a‘ūdhu bika min sharri mā ṣana‘t, abū’u laka bini‘matika ‘alayya, wa abū’u bidhanbī faghfir lī, fa innahu lā yaghfirudh-dhunūba illā anta",
    meaning:

...
import { AdhkarItem } from '@/lib/data'
...
export default function AdhkarCard({ item, pageUrl }: AdhkarCardProps) {
    ...
    <div className="border border-gray-200 rounded-lg p-5 space-y-3 hover:border-black transition-colors">
      ...
      <div className="flex flex-col sm:flex-row gap-2 pt-2">
        ...
        <Button
          ...
          className="w-full sm:flex-1 border-gray-300 text-black hover:bg-gray-100 active:scale-95 transition-transform"
        >
        ...
        {count > 0 && (
          <Button
            ...
            size="sm"
            onClick={() => setCount(0)}
            className="w-full sm:flex-1 text-gray-600 hover:text-black active:scale-95 transition-transform"
          >
            Reset
          </Button>
        )}
